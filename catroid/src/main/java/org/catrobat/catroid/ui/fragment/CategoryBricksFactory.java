...
import org.catrobat.catroid.content.bricks.AsuroMotorCalibrationBrick;
...
import org.catrobat.catroid.content.bricks.AsuroTurnAngleBrick;
...
/*		droneBrickList.add(new SetTextBrick(BrickValues.X_POSITION, BrickValues.Y_POSITION,
	...
	private List<Brick> setupAsuroCategoryList() {
		...
		asuroBrickList.add(new AsuroMotorCalibrationBrick(BrickValues.ASURO_BIAS, BrickValues.ASURO_SPEED_FACTOR));
		asuroBrickList.add(new AsuroOdometryCalibrationBrick(BrickValues.ASURO_TRIGGER_INITIAL_LEFT, BrickValues
				.ASURO_TRIGGER_INITIAL_RIGHT, BrickValues.ASURO_HYSTERESIS_INITIAL));
		asuroBrickList.add(new AsuroOdometryDebugBrick(AsuroOdometryDebugBrick.OdometryDebugStatus.LED_ON));
