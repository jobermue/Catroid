...
public class AsuroMotorMoveForwardBrick extends FormulaBrick {
	...
	public AsuroMotorMoveForwardBrick() {
		addAllowedBrickField(BrickField.ASURO_SPEED);
	}

	public AsuroMotorMoveForwardBrick(Motor motor, int speedValue) {
	...
	public AsuroMotorMoveForwardBrick(Motor motor, Formula speedFormula) {
		this.motorEnum = motor;
		this.motor = motorEnum.name();
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, R.layout.brick_asuro_motor_forward, null);
		TextView textSpeed = (TextView) prototypeView.findViewById(R.id.brick_asuro_motor_forward_action_speed_text_view);
		textSpeed.setText(String.valueOf(BrickValues.ASURO_SPEED));

		Spinner asuroProMotorSpinner = (Spinner) prototypeView.findViewById(R.id.brick_asuro_motor_forward_action_spinner);
	...
	@Override
	public Brick clone() {
		return new AsuroMotorMoveForwardBrick(motorEnum,
	...
	public List<SequenceAction> addActionToSequence(Sprite sprite, SequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory().createAsuroMotorMoveForwardActionAction(sprite, motorEnum,
