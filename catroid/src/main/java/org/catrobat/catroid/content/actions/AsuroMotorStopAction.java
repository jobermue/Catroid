...
import org.catrobat.catroid.content.bricks.AsuroMotorStopBrick.Motor;
import org.catrobat.catroid.devices.arduino.asuro.Asuro;

public class AsuroMotorStopAction extends TemporalAction {
	...
	protected void update(float percent) {
		...
		switch (motorEnum) {
			case MOTOR_LEFT:
				...
				break;
			case MOTOR_RIGHT:
				asuro.stopRightMotor();
				break;
			case MOTOR_BOTH:
				asuro.stopAllMovements();
				break;
		}
	}
