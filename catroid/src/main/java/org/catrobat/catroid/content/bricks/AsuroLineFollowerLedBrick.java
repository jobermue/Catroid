...
public class AsuroLineFollowerLedBrick extends BrickBaseType implements OnItemSelectedListener {
	...
	public AsuroLineFollowerLedBrick(LedStatus ledStatus) {
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, R.layout.brick_asuro_set_line_follower_led, null);

		Spinner ledStatusSpinner = (Spinner) prototypeView.findViewById(R.id.brick_asuro_line_follower_led_spinner);
		...
		ArrayAdapter<CharSequence> ledStatusAdapter = ArrayAdapter.createFromResource(context,
				R.array.asuro_line_follower_led_chooser, android.R.layout.simple_spinner_item);
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_asuro_set_line_follower_led, null);
		view = BrickViewProvider.setAlphaOnView(view, alphaValue);

		setCheckboxView(R.id.brick_asuro_line_follower_led_checkbox);

		ArrayAdapter<CharSequence> ledStatusAdapter = ArrayAdapter.createFromResource(context,
				R.array.asuro_line_follower_led_chooser, android.R.layout.simple_spinner_item);
		ledStatusAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

		Spinner ledStatusSpinner = (Spinner) view.findViewById(R.id.brick_asuro_line_follower_led_spinner);
	...
	public List<SequenceAction> addActionToSequence(Sprite sprite, SequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory().createAsuroSetLineFollowerLedAction(ledStatusEnum));
		return null;
	}
}
