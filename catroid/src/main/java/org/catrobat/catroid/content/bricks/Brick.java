...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField {
		...
		ASURO_SPEED, ASURO_DURATION_IN_SECONDS, ASURO_LIGHT_RED, ASURO_LIGHT_GREEN, ASURO_LED_STATUS,
		IF_ASURO_SENSOR_CONDITION, ASURO_BIAS, ASURO_SPEED_FACTOR, ASURO_STEPS_LEFT, ASURO_STEPS_RIGHT,
		ASURO_TRIGGER_LEFT, ASURO_TRIGGER_RIGHT, ASURO_HYSTERESIS, ASURO_ANGLE, ASURO_STEPS,
