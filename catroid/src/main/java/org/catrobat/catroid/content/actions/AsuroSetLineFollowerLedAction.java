...
import org.catrobat.catroid.content.bricks.AsuroLineFollowerLedBrick.LedStatus;
import org.catrobat.catroid.devices.arduino.asuro.Asuro;

public class AsuroSetLineFollowerLedAction extends TemporalAction {
	...
	protected void update(float percent) {
		...
		switch (ledStatusEnum) {
			case LED_OFF:
				asuro.setFrontLED(false);
				break;
			case LED_ON:
				asuro.setFrontLED(true);
				break;
		}
	}
